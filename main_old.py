...
# Load Data
# We will use torchvision and torch.utils.datapackages for loading data.
...
# In the following, parameter 'schedule' is an LR scheduler object from torch.optim.lr_scheduler.
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train', 'val']:
            if phase == 'train':
                ...
                model.eval()    # Set model to evalutate mode
            ...
            for inputs, labels in dataloaders[phase]:
                ...
                with torch.set_grad_enabled(phase == 'train'):
                    ...
                    # backward + optimize onlt if in training phase
                    if phase == 'train':
                        # Compute gradients automatically
                        # The gradients will be accumulated into .grad attributes
                        loss.backward()
                        optimizer.step()
